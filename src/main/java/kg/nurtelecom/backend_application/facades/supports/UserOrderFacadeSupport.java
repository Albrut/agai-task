...
@Component
@Qualifier("userOrderFacade")
public class UserOrderFacadeSupport implements UserOrderFacade {
    private final UserService userService;
    private final OrderService orderService;
    private final AdminProductFacade adminProductFacade;

    public UserOrderFacadeSupport(OrderService orderService,
    ...
    @Override
    public String deleteOrder(UUID userId) {
        orderService.deleteOrderById(userId);
    ...
    public String createOrder(OrderItemsRequestsDTO orderItemsDTO) {
        ...
        return "redirect:/user/orders/edit/" + newOrderId;
    }
}
